...
// =============================================================================
// Blinding-factor scalar arithmetic
// =============================================================================
...
// =============================================================================
// Slate construction — sender init (S1)
// =============================================================================
...
pub fn grin_adaptor_partial_verify(
    ...
    grin_ext::adaptor_partial_verify(
        &s, &r_i, &p_i, &r_total, &p_total, &t_point, &msg,
    )
    .map_err(|e| JsValue::from_str(&e))
}
...
// =============================================================================
// Slate construction — receiver round (S2) and sender finalize (S3)
// =============================================================================
