...
pub use grin::{
    ...
    grin_pubkey_to_commitment, grin_receiver_round_s2, grin_schnorr_sign, grin_schnorr_verify,
    grin_secp256k1_public_key, grin_sender_blind_excess, grin_sender_finalize_s3,
    grin_sender_init_s1, grin_slate_round_trip, grin_slate_summary,
    grin_slate_to_transaction_bytes, grin_slatepack_address,
